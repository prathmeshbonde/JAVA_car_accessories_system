...
public class A_CUSDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        par.setFont(new java.awt.Font("Times new roman", 0, 13));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CLIENT NAME", "CUSTOMER NAME ", "E-MAIL", "MOBILE NO ", "ADHARCARD NO.", "ACCESS MODEL", "ACCESS COLOUR ", "DATEOFORDER ", "ECA"
            }
        ));
        ...
        parc.setForeground(Color.white);
        ...
        jPanel1.add(parc);
        parc.setBounds(330, 200, 180, 23);
        parc.setFont(new java.awt.Font("Times new roman", 0, 13));
