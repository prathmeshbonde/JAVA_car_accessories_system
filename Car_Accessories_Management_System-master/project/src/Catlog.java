...
public class Catlog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(800, 70, 410, 80);
        jButton1.setFont(new java.awt.Font("Algerian", 0, 23));
        ...
        jComboBox1.setBounds(150, 70, 510, 80);
        jComboBox1.setFont(new java.awt.Font("Algerian", 0, 20));
        ...
        jScrollPane2.setBounds(40, 400, 1350, 250);
...
Interior  ==      4
    */
    switch(ind){
         case 0:image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security.png")));
                break; 
         case 1:image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imageMercedes-Benz_cla.png")));
                break;
         case 2:image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/blue1.png")));
                break;
         case 3:image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/media.jpg")));
                break;
         case 4:image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interior.png")));
                break;
