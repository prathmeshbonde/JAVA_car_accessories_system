...
public class C_OrderAcc extends javax.swing.JFrame {
Var cli=new Var();
    /**
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(48, 25, 52));

        jLabel1.setFont(new java.awt.Font("Algerian", 0, 36)); // NOI18N
        jLabel1.setForeground(Color.white);
        jLabel1.setText("<HTML><BODY><U>order</U></BOD Y></HTML>");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(570, 30, 300, 50);
        ...
        jLabel7.setText("<HTML><BODY><U>ACCESSORY DETAILS</U></BODY></HTML>");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(498, 370, 146, 40);
        jLabel7.setForeground(Color.white);

        jLabel10.setFont(new java.awt.Font("Tekton Pro Ext", 0, 14)); // NOI18N
        jLabel10.setText("ACCESSORY MODEL");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(380, 420, 150, 60);
        jLabel10.setForeground(Color.white);

        jLabel11.setFont(new java.awt.Font("Tekton Pro Ext", 0, 14)); // NOI18N
        jLabel11.setText("ACCESSORY COLOR");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(380, 500, 150, 20);
        jLabel11.setForeground(Color.white);
        
        jLabel12.setFont(new java.awt.Font("Tekton Pro Ext", 0, 14)); // NOI18N
        jLabel12.setText(" EXTRA CAR  ACCESORIES");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(350, 610, 230, 20);
        jLabel12.setForeground(Color.white);

        buttonGroup2.add(yes);
        yes.setText("YES");
        jPanel1.add(yes);
        yes.setBounds(610, 610, 60, 23);
        ...
        jLabel13.setBounds(780, 560, 170, 20);
        jPanel1.add(cc);
        cc.setBounds(610, 500, 150, 30);
        jPanel1.add(mob);
        ...
        jButton3.setBounds(540, 700, 150, 40);
        ...
        jLabel14.setBounds(420, 550, 140, 20);
        jPanel1.add(datee);
        datee.setBounds(610, 550, 150, 30);
        ...
        jLabel15.setBounds(390, 660, 490, 20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_OrderAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
